package com.pauline.propertyplus2.ui.theme.screens.login
...
import com.pauline.propertyplus2.data.AuthViewModel
import com.pauline.propertyplus2.R
import com.pauline.propertyplus2.navigation.ROUT_HOME
...
fun LoginScreen(navController:NavHostController){
    Column(
        modifier = Modifier
            .paint(painter = painterResource(R.drawable.girl), contentScale = ContentScale.FillBounds)
            .fillMaxSize(),
